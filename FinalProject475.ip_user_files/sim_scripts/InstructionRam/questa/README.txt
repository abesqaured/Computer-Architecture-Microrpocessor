...
#
# Generated by export_simulation on Wed May 10 10:57:31 -0400 2017
#
################################################################################
...
switch to the './InstructionRam.sh' script.

./InstructionRam.sh -reset_run
...
./InstructionRam.sh -noclean_files

For more information on the script, please type './InstructionRam.sh -help'.
